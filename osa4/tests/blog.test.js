...
describe('favorite blog', () => {
  ...
  test('when list has only one blog equals that', () => {
    expect(listHelper.favoriteBlog(listWithOneBlog).title).toBe('Go To Statement Considered Harmful')
  })

  test('of a bigger list is the blog with most likes', () => {
    expect(listHelper.favoriteBlog(biggerListOfBlogs).title).toBe('Canonical string reduction')
  })
})
...
describe('most blogs', () => {
  ...
  test('of a bigger list is the author with most blogs', () => {
    expect(listHelper.mostBlogs(biggerListOfBlogs).author).toBe('Robert C. Martin')
  })
})